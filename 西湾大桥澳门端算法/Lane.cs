...
namespace Gqqnbig.TrafficVolumeMonitor
{
    public class Lane : ILane
    {
        ...
        private Image<Bgr, byte> PerspectiveTransform(Image<Bgr, byte> image)
        {
            ...
            srcs[0] = new PointF(123, 132);
            srcs[1] = new PointF(95, 286);
            srcs[2] = new PointF(136, 286);
            srcs[3] = new PointF(144, 132);


            PointF[] dsts = new PointF[4];
            dsts[0] = new PointF(100, 132);
            dsts[1] = new PointF(95, 286);
            dsts[2] = new PointF(136, 286);
            dsts[3] = new PointF(131, 132);
